...
import { Mail, Phone, ArrowUpRight, AlertTriangle } from 'lucide-react';
      ...
      <Modal isOpen={emailModal} onClose={() => setEmailModal(false)} title={`${tone.charAt(0).toUpperCase() + tone.slice(1)} Email — ${account.client}`} size="lg">
        <div className="space-y-4">
          ...
          <div className="bg-bg-secondary rounded-xl p-4">
            ...
            <pre className="text-sm text-text-secondary leading-relaxed whitespace-pre-wrap font-sans">{account.emailDrafts[tone]}</pre>
          </div>
          <div className="flex gap-3">
            ...
            <button onClick={() => setEmailModal(false)} className="flex-1 py-2.5 rounded-lg bg-accent-blue text-white text-sm font-medium flex items-center justify-center gap-2">
